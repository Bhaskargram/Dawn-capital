...
const seedDB = async () => {
  ...
  try {
    ...
    const landingConfig = {
      ...
      aboutUs: 'Dawn Capital stands as a cornerstone of the global financial landscape. As a leading financial holding company, we provide diverse solutions across sectors including housing finance, asset management, life insurance, and advisory services. Our approach is rooted in precision and transparency, serving a sophisticated clientele of institutional investors and high-net-worth individuals.',
      services: [
      ...
      faq: [
        { question: 'How do I start an investment with Dawn Capital?', answer: 'You can begin by creating a customer account through our portal. Once registered, your dedicated advisor will help you explore FD, RD, and other investment vehicles tailored to your risk profile.' },
        ...
        { question: 'Is my data secure with Dawn Capital?', answer: 'Absolutely. We use bank-grade encryption (AES-256), JWT-based authentication, and follow strict data privacy protocols compliant with RBI and international standards.' }
      ]
    };
    ...
    if (config) {
      ...
      await SystemConfig.create({
        ...
        contact: { email: 'contact@dawncapital.com', phone: '+1 (800) DAWN-CAP' }
      });
